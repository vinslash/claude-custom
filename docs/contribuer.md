...
| `install.sh` ou `bin/update.sh` | `docs/installation.md`, et `README.md` si les commandes d'installation bougent | Les comportements décrits conformes au script, pas à l'intention |
